...
<br><br><br><br><br><br>
    <table border="0" width="100%">
        <tr><td>
    <div id="wrapper">
        <a href="php/Videoplayer.php" class="my-super-cool-btn">
          ...
          <span>VIDEO<BR>player
          </span>
        </a>
      </div></td>
      <td>
      <div id="wrapper">
        <a href="php/musicplayer.php" class="my-super-cool-btn">
          <div class="dots-container">
            <div class="dot"></div>
            <div class="dot"></div>
            <div class="dot"></div>
